...
// the following app.get shows only logText
  ...
  app.post("/api/searches", function(req, res) {
    ...
    db.Search.create({
      ...
      client.post('statuses/update', {status: '#SFSP #FreeSummerMeals2019' + '\n' + '\n' + req.body.logText + '\n' + '\n'  + 'Find the sites nearest you: https://SummerFoodRocks.org/sitefinder'}, function(error, tweet, response) {
        if (!error) {
          // console.log(tweet);
        }
      });
