...
function initMap() {
  ...
  autocomplete.addListener('place_changed', function() {
    ...
    queryTermsAnon = `${place.address_components[1].long_name}, ${place.address_components[2].long_name}, ${place.address_components[4].short_name}, ${place.address_components[6].long_name}`;
    console.log(queryTermsAnon);
